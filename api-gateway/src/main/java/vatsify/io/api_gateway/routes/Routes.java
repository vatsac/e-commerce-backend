package vatsify.io.api_gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoute(){
        return route("product_service")
                .route(RequestPredicates.path("/api/product"), HandlerFunctions.http("https://e-commerce-backend-microservice-production.up.railway.app"))
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute(){
        return route("product_service_swagger")
                .route(RequestPredicates.path("/aggregate/product-service/v3/api-docs"), HandlerFunctions.http("https://e-commerce-backend-microservice-production.up.railway.app"))
